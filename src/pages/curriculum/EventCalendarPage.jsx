...
import { FaCalendarAlt, FaClock, FaMapMarkerAlt, FaUsers, FaStar, FaArrowRight, FaGraduationCap, FaTrophy, FaBookOpen, FaHeart } from 'react-icons/fa';
  ...
  return (
    <>
      ...
      <div className="min-h-screen relative overflow-hidden">
        {/* Animated Background */}
        <div className="absolute inset-0 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-slate-900 dark:via-purple-900 dark:to-indigo-900">
        ...
        <div className="relative z-10 py-12 px-4 sm:px-6 lg:px-8">
          ...
          <div className={`text-center ${isVisible ? 'slide-in-up' : 'opacity-0'}`} style={{animationDelay: '1200ms'}}>
            <div className="bg-white/30 dark:bg-white/10 backdrop-blur-md rounded-3xl p-8 max-w-2xl mx-auto border border-white/20">
              ...
              <div className="inline-flex items-center justify-center bg-purple-500 hover:bg-purple-600 text-white font-semibold px-8 py-3 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl cursor-pointer">
